...
public class AppointmentCheckerGuichet1Job implements Job {

    final static Logger logger = Logger.getLogger(AppointmentCheckerGuichet1Job.class);
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        try {
            ...
            takeAppointment("GUICHET 1 ", guichet1);

            Thread.sleep(20000);

            takeAppointment("GUICHET 2", guichet2);
    ...
    private static String takeAppointment(String guichet , String guichetId) throws IOException, InterruptedException {
        ...
        while (trials < 5 && page == null) {
            ...
            try {
                ...
                final DomElement guichetRadio = page.getElementById(guichetId);
        ...
        if (page == null ) {
            logger.warn("Le site est actuellement injoinable au " + guichet);
            failedTrials ++;
            return "Le site est actuellement injoinable au " + guichet;
        }
        ...
        while (takenMsg.getTextContent().contains("Choix de la nature du rendez-vous") && trials < 3) {
            ...
            page.getElementById(guichetId).click();
            Thread.sleep(1000);
        ...
        if (takenMsg.getTextContent().contains("existe plus de plage horaire libre") ) {
            ...
            logger.info(" PAS DE RENDEZ-VOUS DISPO AU " + guichet );
            return responseMsg.getTextContent();

        } else {

            logger.info("Reponse : " + takenMsg.getTextContent());
            TelegramMessageSender.sendMessage("YEEES :D  RENDEZ-VOUS DISPO  AU " + guichet);
            return "YEEES :D  RENDEZ-VOUS DISPO  AU " + guichet;
