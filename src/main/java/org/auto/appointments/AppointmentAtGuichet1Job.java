...
public class AppointmentAtGuichet1Job implements Job {

    final static Logger logger = Logger.getLogger(AppointmentAtGuichet1Job.class);
    ...
    public static String retryAppointment() throws IOException, InterruptedException {
        ...
        driver.quit();
        return "Tentative de prise de rendez-vous demandé par l'utilisateur";
    ...
    private static void excecuteAppointment(WebDriver driver, String guichetName, String guichetId) {
        ...
        try {
            ...
            driver.get("https://www.essonne.gouv.fr/booking/create/29728/0");
            ...
            if (driver.findElement(By.id("inner_Booking")).getText().contains("existe plus de plage horaire libre")) {
                trialsNumber ++;
                logger.info("[" + trialsNumber +"] - PAS DE RENDEZ-VOUS DISPO AU :( ");
                ...
                try {
                    ...
                    logger.info(TelegramMessageSender.sendMessage("!!!! RENDEZ-VOUS DISPO FAITES VITE  !!!! :D \n https://www.essonne.gouv.fr/booking/create/29728/0"));
                    trialsNumber ++;
                } catch (IOException e) {
                    e.printStackTrace();
